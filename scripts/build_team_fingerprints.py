...
from moreymachine.features.team_fingerprints import (  # noqa: E402
...
def main() -> int:
    """CLI entry point for team fingerprint builds."""
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--input", type=Path, default=TEAM_SEASONS_WITH_TIERS_PATH)
    parser.add_argument("--output", type=Path, default=TEAM_FINGERPRINTS_PATH)
    args = parser.parse_args()

    result = build_team_fingerprints(input_path=args.input, output_path=args.output)
